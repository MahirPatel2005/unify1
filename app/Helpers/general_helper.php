...
if (!function_exists("get_logo_url")) {
    ...
    function get_logo_url() {
        ...
        if (is_file($logo_path)) {
            return get_file_uri("assets/images/logo.png");
        }
...
if (!function_exists("get_favicon_url")) {
    ...
    function get_favicon_url() {
        ...
        if ($favicon_from_setting) {
            return $favicon_from_setting;
        }

        return get_file_uri("assets/images/favicon.png");
    }
}
...
if (!function_exists("get_apple_touch_icon_url")) {
    ...
    function get_apple_touch_icon_url() {
        $icon_path = FCPATH . "assets/images/favicon-192.png";
        if (is_file($icon_path)) {
            return get_file_uri("assets/images/favicon-192.png");
        }
