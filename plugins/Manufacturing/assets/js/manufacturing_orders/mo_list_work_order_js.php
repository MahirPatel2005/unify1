...
<script>
	...
	$(function () {
		...
		initDataTable(mo_work_order_table, "<?php echo get_uri("manufacturing/mo_work_order_table") ?>",[0],[0], InvoiceServerParams, [0 ,'desc']);
	...
	$(function () {
		...
		var work_orders = <?php echo html_entity_decode(json_encode($data_timeline)); ?>;
