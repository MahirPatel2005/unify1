<script>
	...
	$('.mark_as_todo').on('click', function() {
		...
		$.get("<?php echo get_uri("manufacturing/mo_mark_as_todo/") ?>" + id+'/mark_as_todo', function (response) {
	...
	$('.mark_check_availability').on('click', function() {
		...
		var id = $("input[name='id']").val();
		$.get("<?php echo get_uri("manufacturing/mo_mark_as_todo/") ?>" + id+'/check_availability', function (response) {
			if(response.status == 'warning'){
				appAlert.success(response.message);
				setTimeout(function(){ location.reload(); }, 5000);
			}else{
	...
	$('.mark_as_done').on('click', function() {
		...
		$.get("<?php echo get_uri("manufacturing/mo_mark_as_done/") ?>" + id, function (response) {
			appAlert.success(response.message);
	...
	$('.mark_as_planned').on('click', function() {
		...
		$.get("<?php echo get_uri("manufacturing/mo_mark_as_planned/") ?>" + id, function (response) {
			appAlert.success(response.message);
	...
	$('.mark_as_unreserved').on('click', function() {
		...
		$.get("<?php echo get_uri("manufacturing/mo_mark_as_unreserved/") ?>" + id, function (response) {
			appAlert.success(response.message);
	...
	$('.mark_as_cancel').on('click', function() {
		...
		$.get("<?php echo get_uri("manufacturing/mo_mark_as_cancel/") ?>" + id, function (response) {
			appAlert.success(response.message);
	...
	$('.mo_create_purchase_request').on('click', function() {
		...
		$.get("<?php echo get_uri("manufacturing/mo_create_purchase_request/") ?>" + id, function (response) {
			appAlert.success(response.message);
