   ...
   <div class="modal-body clearfix">
      <div class="row">
         <div class="col-md-12 border-right project_file_area">
            ...
            if(is_image($path)){ ?>
               <img src="<?php echo base_url(MANUFACTURING_OPERATION_ATTACHMENTS_UPLOAD_FOLDER.'/'.$file->rel_id.'/'.$file->file_name); ?>" class="img img-responsive ">
            ...
            <?php } else if(strpos($file->file_name,'.pdf') !== false && empty($file->external)){ ?>
               <iframe src="<?php echo base_url(MANUFACTURING_OPERATION_ATTACHMENTS_UPLOAD_FOLDER.'/'.$file->rel_id.'/'.$file->file_name); ?>" height="100%" width="100%" frameborder="0"></iframe>
            <?php } else if(strpos($file->file_name,'.xls') !== false && empty($file->external)){ ?>
               <iframe src='https://view.officeapps.live.com/op/embed.aspx?src=<?php echo base_url(MANUFACTURING_OPERATION_ATTACHMENTS_UPLOAD_FOLDER.'/'.$file->rel_id.'/'.$file->file_name); ?>' width='100%' height='100%' frameborder='0'>
               </iframe>
...
<?php require 'plugins/Manufacturing/assets/js/file_js.php';?>
