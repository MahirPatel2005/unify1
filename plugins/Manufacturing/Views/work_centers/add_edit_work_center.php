...
<div id="page-content" class="page-wrapper clearfix">
	<div class="row">
		...
		if(isset($work_center)){
			$title .= app_lang('update_work_center');
			$id    = $work_center->id;
		}else{
			$title .= app_lang('add_work_center');
		}

		?>

		<?php echo form_open_multipart(site_url('manufacturing/add_edit_work_center/'.$id), array('id' => 'add_update_work_center','autocomplete'=>'off', 'class' => 'general-form')); ?>
				...
				<div class="modal-body">
					<div class="tab-content">
						...
						<div class="row">
							<div class="row">
								<div class="col-md-6">
									...
									<?php echo render_input1('work_center_name','work_center_name',$work_center_name,'text', [], [], '', '', true); ?>   
								</div>
								<div class="col-md-6">
									<?php echo render_input1('work_center_code','work_center_code',$work_center_code,'text'); ?>   
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
									<?php echo render_select1('working_hours',$working_hours,array('id','working_hour_name'),'work_center_working_hours',$working_hour_selected); ?>
						...
						<div class="row">
							...
							<div class="row">
								<div class="col-md-6">
									<?php echo render_input1('time_efficiency','time_efficiency',$time_efficiency,'number'); ?>   
								</div>
								<div class="col-md-6">
									<?php echo render_input1('costs_hour','costs_hour',$costs_hour,'number'); ?>   
								</div>
								<div class="col-md-6">
									<?php echo render_input1('capacity','work_center_capacity',$capacity,'number'); ?>   
								</div>
								<div class="col-md-6">
									<?php echo render_input1('oee_target','oee_target',$oee_target,'number'); ?>   
								</div>
								<div class="col-md-6">
									<?php echo render_input1('time_start','work_center_time_start',$time_start,'number'); ?>   
								</div>
								<div class="col-md-6">
									<?php echo render_input1('time_stop','time_stop',$time_stop,'number'); ?>   
								</div>
								<div class="col-md-12">
									<p class="bold"><?php echo app_lang('work_center_description'); ?></p>
	...
	<!-- init_tail -->
	<?php require 'plugins/Manufacturing/assets/js/work_centers/add_edit_work_center_js.php';?>
