			...
			<div class="col-md-3">
				<ul class="nav navbar-pills navbar-pills-flat nav-tabs nav-stacked">
					...
					foreach($tab as $gr){
						...
						<a href="<?php echo site_url('manufacturing/setting?group='.$gr); ?>" data-group="<?php echo html_entity_decode($gr); ?>">
							<?
								...
								if($gr == 'prefix_number'){
									echo html_entity_decode($icon[$gr] .' '. app_lang('mrp_general_setting')); 

								}else{

									echo html_entity_decode($icon[$gr] .' '. app_lang($gr)); 
								}
