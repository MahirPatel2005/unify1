<?php
$settings_menu = array(
	"manufacturing_settings" => array(
		array("name" => "working_hour", "url" => "manufacturing/working_hours"),
		array("name" => "unit_of_measure_categories", "url" => "manufacturing/unit_of_measure_categories"),
		array("name" => "unit_of_measure", "url" => "manufacturing/unit_of_measures"),
		array("name" => "mrp_general_setting", "url" => "manufacturing/prefix_numbers"),
	),

);

if($login_user->is_admin){
	array_push($settings_menu["manufacturing_settings"], array("name" => "permission_roles", "url" => "manufacturing/roles"));
}
