<div class="tab-content">
	<?php echo form_open(get_uri("manufacturing/role_save_permissions"), array("id" => "permissions-form", "class" => "general-form dashed-row", "role" => "form")); ?>
	...
	<div class="card">
		...
		<div class="card-body">
			...
			<ul class="permission-list">
				<?php echo  view('Manufacturing\Views\settings\manufacturing_permissions', $permissions); ?>
...
<?php 
require 'plugins/Manufacturing/assets/js/roles/permissions_js.php';
?>