				...
				<?php foreach ($p_variant as $value) { ?>
					...
					<div class="col-md-6">
						<div class ="form-group">
							...
							<select name="variation_names_<?php echo html_entity_decode($value->name); ?>" class="select2 validate-hidden"  data-live-search="true" data-width="100%" data-none-selected-text="" required>
								<option value=""></option>
		...
		<div class="col-md-11">
			...
			<div class="col-md-8">
				<div class="options_wrapper">
					...
					<?php echo render_textarea1('options[0]', 'variation_options', '', $variation_attr); ?>
				</div>
			</div>
		</div>
		<div class="col-md-1 new_vendor_requests_button">
			<span class="pull-bot">
				<button name="add" class="btn new_wh_approval btn-success" data-ticket="true" type="button"><span data-feather="plus-circle" class="icon-16" ></span></i></button>
			</span>
		</div>
	</div>
	<?php } ?>