		...
		<div class="col-md-12" id="small-table">
			...
			<div class="card">
						...
						<div class="form-group">
							<select name="item_filter[]" id="item_filter" class="select2 validate-hidden" multiple="true" data-actions-box="true" data-live-search="true" data-width="100%" placeholder="<?php echo app_lang('product_label'); ?>">
								...
								<?php foreach($product_variants as $product_variant) { ?>
									<option value="<?php echo html_entity_decode($product_variant['id']); ?>"><?php echo html_entity_decode($product_variant['commodity_code'].' '.$product_variant['title']); ?></option>
								<?php } ?>
				...
				<div class="row">
					<div class="col-md-12">
						<!-- view/manage -->            
						<div class="modal fade bulk_actions" id="product_variant_table_bulk_actions" tabindex="-1" role="dialog">
						...
						<a href="#"  onclick="staff_bulk_actions(); return false;" data-toggle="modal" data-table=".table-product_variant_table" data-target="#leads_bulk_actions" class=" hide bulk-actions-btn table-btn"><?php echo app_lang('bulk_actions'); ?></a>

						<a class="hide" href="#"  onclick="staff_export_item(); return false;" data-toggle="modal" data-table=".table-product_variant_table" data-target="#leads_export_item" class=" hide bulk-actions-btn table-btn"><?php echo app_lang('export_item'); ?></a>

						<a href="#"  onclick="print_barcode_bulk_actions(); return false;" data-toggle="modal" data-table=".table-product_variant_table" data-target="#print_barcode_item" class=" hide print_barcode-bulk-actions-btn table-btn"><?php echo app_lang('print_barcode'); ?></a>

						<?php 
						$table_data = array(
							'<span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="product_variant_table" class="form-check-input"><label></label></div>',
							app_lang('_images'),
						...
						render_datatable1($table_data,'product_variant_table',
					); ?>
...
<!-- init_tail -->
<?php require 'plugins/Manufacturing/assets/js/products/product_variant_management_js.php';?>
</body>
</html>
