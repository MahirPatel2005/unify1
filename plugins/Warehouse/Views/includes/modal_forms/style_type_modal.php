<?php echo form_open(get_uri("warehouse/style_type/".$id), array("id" => "style_type-form", "class" => "general-form", "role" => "form")); ?>
...
<?php echo form_close(); ?>
<?php require('plugins/Warehouse/assets/js/settings/modal_forms/style_type_modal_js.php'); ?>
