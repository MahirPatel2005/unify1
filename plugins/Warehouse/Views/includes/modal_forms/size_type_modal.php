<?php echo form_open(get_uri("warehouse/size_type/".$id), array("id" => "size_type-form", "class" => "general-form", "role" => "form")); ?>
...
<?php echo form_close(); ?>
<?php require('plugins/Warehouse/assets/js/settings/modal_forms/size_type_modal_js.php'); ?>
