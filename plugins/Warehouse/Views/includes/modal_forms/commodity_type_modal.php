<?php echo form_open(get_uri("warehouse/commodity_type/".$id), array("id" => "commodity_type-form", "class" => "general-form", "role" => "form")); ?>
...
<?php echo form_close(); ?>
<?php require('plugins/Warehouse/assets/js/settings/modal_forms/commodity_type_modal_js.php'); ?>
