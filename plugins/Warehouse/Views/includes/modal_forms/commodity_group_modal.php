<?php echo form_open(get_uri("warehouse/commodity_group_type/".$id), array("id" => "commodity_group-form", "class" => "general-form", "role" => "form")); ?>
<div id="items-dropzone" class="post-dropzone">
	<div class="modal-body clearfix">
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12">
					<div id="commodity_group_id">
					</div>   
					<div class="form"> 
...
<?php echo form_close(); ?>
<?php require('plugins/Warehouse/assets/js/settings/modal_forms/commodity_group_modal_js.php'); ?>
