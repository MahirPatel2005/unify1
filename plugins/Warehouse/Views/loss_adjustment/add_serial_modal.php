...
<div id="items-dropzone" class="post-dropzone">
	...
	<div class="modal-footer">
		...
		<a href="javascript:void(0)"class="btn btn-info pull-right mright10 display-block btn_submit_multiple_serial_number text-white" ><span data-feather="check-circle" class="icon-16" ></span> <?php echo app_lang('submit'); ?></a>
	</div>
</div>
<?php echo form_close(); ?>
<?php require 'plugins/Warehouse/assets/js/loss_adjustments/adjustment_fill_multiple_serial_number_js.php';?>
